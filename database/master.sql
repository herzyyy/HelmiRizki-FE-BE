...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Des 2024 pada 17.59
...
(25, 'Helmi Rizki', 'Bogor', '2023/2024', '2024-12-14', 1),
(30, 'ffff', 'ffff', '2023/2024', '2024-12-14', 2);
...
--
ALTER TABLE `penelitian`
  MODIFY `kd_penelitian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
